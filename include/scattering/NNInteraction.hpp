...
class NNInteraction
{
    ...
    public:
        NNInteraction(ScatteringProcess* scattering, gsl_complex M_nucleon, int lenZ, int lenTau, double tauCutoffLower, double tauCutoffUpper, double zCutoffLower, double zCutoffUpper);
