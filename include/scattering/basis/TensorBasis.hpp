...
#include "../../utils/tensor/Tensor22.hpp"
...
class TensorBasis
{
    private:
        ...
        Tensor22<4, 4, 4, 4>** tauGrid;
        Tensor22<4, 4, 4, 4>** tauGridTimelike;

        gsl_matrix_complex** KMatrixGrid;
        gsl_matrix_complex** KInverseMatrixGrid;

        void calculateBasis(int impulseIdx, Tensor22<4, 4, 4, 4>** tauGridCurrent, gsl_vector_complex* p_f, gsl_vector_complex* p_i, gsl_vector_complex* k_f, gsl_vector_complex* k_i, gsl_vector_complex* P);
        ...
        void calculateKMatrix(int impulseIdx, Tensor22<4, 4, 4, 4>** tauGridCurrent);
    ...
    public:
        ...
        Tensor22<4, 4, 4, 4>* tauGridAt(int basisElemIdx);


        explicit operator std::string() const;

        Tensor22<4, 4, 4, 4>* tau(int basisElemIdx, int externalImpulseIdx);
