...
class MomentumLoop
{
    public:
        ...
        virtual gsl_complex integrate_4d_deformed(const std::function<gsl_complex(gsl_complex, double, double, double)>& f, double cutoff, double X, double epsilon, double eta) = 0;
